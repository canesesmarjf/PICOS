...
box on
hold on
hn(1) = plot(x_m,n_m{1}(:,1),'r');
hn(2) = plot(x_m,n_m{1}(:,end),'k');
plot(x_m,n_m{1}(:,1:3:end),'k')
...
box on
hold on
hT(1) = plot(x_m,Tpar_m{1}(:,1),'r');
hT(2) = plot(x_m,Tpar_m{1}(:,end),'k');
plot(x_m,Tpar_m{1}(:,1:5:end),'k')
...
box on
hold on
hT(1) = plot(x_m,Tper_m{1}(:,1),'r');
hT(2) = plot(x_m,Tper_m{1}(:,end),'k');
plot(x_m,Tper_m{1}(:,1:5:end),'k');
